    ...
    private final OnClickListener onDayOfMonthClickListener = new OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (robotoCalendarListener == null) {
                ...
                robotoCalendarListener.onDayClick(String.valueOf(currentCalendar.get(Calendar.YEAR))+"/"+String.valueOf(currentCalendar.get(Calendar.MONTH)+1)+"/"+dayOfTheMonthText.getText().toString());
            }
        }
    };
...
//            }
    ...
    public void markCircleImage1(@NonNull String date) {
        Calendar calendar = Calendar.getInstance();
        String[] a=date.split("/");
    ...
    public void markCircleImage2(@NonNull String date) {
        Calendar calendar = Calendar.getInstance();
        String[] a=date.split("/");
        int year=Integer.valueOf(a[0]);
        int month=Integer.valueOf(a[1])-1;
    ...
    private void setUpEventListeners() {
        ...
        leftButton.setOnClickListener(view -> {
           if (robotoCalendarListener == null) {
            ...
            count=count+1;
            updateView();
            robotoCalendarListener.onLeftButtonClick(String.valueOf(currentCalendar.get(Calendar.YEAR))+"/"+String.valueOf(currentCalendar.get(Calendar.MONTH)+1)+"/");
        });
        dateTitle.setOnClickListener(v -> {
            ...
            count=0;
            updateView();
            robotoCalendarListener.onMonthClick();
        });
        rightButton.setOnClickListener(view -> {
            ...
            count=count-1;
            updateView();
            robotoCalendarListener.onRightButtonClick(String.valueOf(currentCalendar.get(Calendar.YEAR))+"/"+String.valueOf(currentCalendar.get(Calendar.MONTH)+1)+"/");        });
    }
    ...
    public interface RobotoCalendarListener {
        ...
        void onRightButtonClick(String right);

        void onLeftButtonClick(String left);
        void onMonthClick();
    }
